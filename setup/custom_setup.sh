...
src=src/KeyRepo/setup/changed_files_in_kernel
mkdir linux-5.4.80/krepo
cp $src/krepo/* linux-5.4.80/krepo
cp src/KeyRepo/source/KernelEmulation.c linux-5.4.80/krepo/krepo.c
cp src/KeyRepo/include/KeyRepoHeaders.h linux-5.4.80/krepo
